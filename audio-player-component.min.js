(() => {
  ...
  var u = {
    ...
    constructor() {
      super(), this.#o = this.attachShadow({ mode: "open" }), this.#e = this.getAttribute("title"), this.#a = this.getAttribute("artist"), this.#r = this.getAttribute("image") || "", this.#s = this.getAttribute("compact") !== null, this.#n = this.getAttribute("blurred") !== "false" || !(this.#e && this.#a);
    ...
    static createElement({ tagName: e = "div", className: a = "", ...s } = {}) {
    ...
    addOverlayToContainer(e) {
      ...
      let s = t.createElement({ className: "tap--overlay" }), i = t.createElement({ className: "tap--metadata" }), r = t.createElement({
        tagName: "span",
      ...
      i.appendChild(r), i.appendChild(o), e.appendChild(s), e.appendChild(i);
    }
    createPlayer() {
      let e = t.createElement({ className: "tap--container" });
      this.#s || (e.style.minHeight = `${this.#l}px`), this.addOverlayToContainer(e);
      let a = t.createElement({ className: "tap--controls" }), s = t.createElement({ className: "tap--progress--bar" }), i = t.createElement({ className: "tap--progress--playhead" }), r = t.createElement({ className: "tap--progress--timestamp" }), o = t.createElement({ tagName: "button", className: "tap--button" });
      o.innerHTML = t.svgPlay;
      let l = () => {
        ...
        r.innerHTML = `${n}:${d}<br/>${g}:${m}`, i.style.width = `${this.#t.currentTime * 100 / (this.#t.duration || 1)}%`;
      };
      o.onclick = () => {
        if (!this.#i) {
      ...
      if (s.onmousedown = () => {
        ...
        p = !1;
      }, s.onmousemove = (n) => p && h(n), s.onclick = h, s.appendChild(i), a.appendChild(o), a.appendChild(s), a.appendChild(r), l(), this.#t.ondurationchange = l, this.#t.ontimeupdate = l, this.#t.onended = () => {
