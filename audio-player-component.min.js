(() => {
  ...
  var m = {
    ...
    constructor() {
      super(), this.#r = this.attachShadow({ mode: "open" }), this.#o = this.getAttribute("title"), this.#e = this.getAttribute("artist"), this.#a = this.getAttribute("album"), this.#n = this.getAttribute("compact") !== null;
    ...
    addOverlayToContainer(t) {
      ...
      if ((i === null ? !!(this.#o && this.#e && this.#a) : i !== "false") && a.classList.add("blurred"), t.appendChild(a), !(this.#o || this.#e || this.#a)) return;
      ...
      let s = e.createElement({
        tagName: "span",
        className: "tap--metadata__artist",
        textContent: n
      });
      o.appendChild(d), o.appendChild(s), t.appendChild(l), t.appendChild(o);
    }
    connectedCallback() {
      this.#r.innerHTML = "", this.#r.appendChild(e.createElement({ tagName: "style", textContent: this.styleCss }));
      ...
      let i = e.createElement({ className: "tap--progress--bar" }), r = e.createElement({ className: "tap--progress--playhead" }), l = e.createElement({ className: "tap--progress--timestamp" });
      this.#i = e.createElement({
        tagName: "button",
      ...
      let o = () => {
        ...
        l.innerHTML = `${p}:${h}<br/>${u}:${g}`, r.style.width = `${this.#t.currentTime * 100 / (this.#t.duration || 1)}%`;
      };
      this.#i.onclick = () => {
        if (!(this.#s && !this.#l)) {
          if (!this.#s) return this.play();
          this.pause();
        }
      };
      let d = (s) => {
      ...
      if (i.onmousedown = () => {
        ...
        n = !1;
      }, i.onmousemove = (s) => n && d(s), i.onclick = d, i.appendChild(r), a.appendChild(this.#i), a.appendChild(i), a.appendChild(l), o(), this.#t.ondurationchange = o, this.#t.ontimeupdate = o, this.#t.onended = () => {
        this.#t.currentTime = 0, this.#s = !1, this.#i.innerHTML = e.svgPlay;
      }, this.#t.style.display = "none", this.#n) {
        this.#r.appendChild(a);
        return;
      }
      t.appendChild(a), this.#r.appendChild(t);
    }
    async play() {
      this.#s = !0, this.#t.readyState <= 1 && (this.#t.load(), this.#i.innerHTML = e.svgLoading), await this.#t.play(), this.#l = !0, this.#i.innerHTML = e.svgPause;
    }
    pause() {
      this.#t.pause(), this.#s = !1, this.#i.innerHTML = e.svgPlay;
    }
    stop() {
